  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a1033] via-[#1a1440] to-[#2a0a3c] flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className={`w-full max-w-md mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden transition-all duration-300 ${
          isKeyboardVisible ? 'max-h-[80vh]' : 'max-h-[90vh]'
        }`}>
          {/* Header del modal */}
          <div className={`text-center p-6 bg-gradient-to-br from-cosmic-magenta to-purple-600 ${
            isKeyboardVisible ? 'pb-4' : 'pb-6'
          }`}>
            ...
            <h1 className={`font-bold text-white mb-2 ${
              isKeyboardVisible ? 'text-xl mb-1' : 'text-2xl mb-2'
            }`}>
              Únete a Amor Astral
            </h1>
            <p className={`text-white/90 leading-relaxed ${
              isKeyboardVisible ? 'text-sm' : 'text-base'
            }`}>
